  ...
  private double calc_imc(double peso, double altura){
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.button.setOnClickListener(v -> {
            try {
                double peso = Double.parseDouble(binding.userHeight.getText().toString());
                double altura = Double.parseDouble(binding.userWeight.getText().toString());

                String resultMessageFormat = getString(R.string.result_message);
                String formattedResultMessage = String.format(resultMessageFormat, calc_imc(peso, altura));

                binding.textResult.setText(formattedResultMessage);
